    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        help_text="Liczba pytań w jednym podejściu",
                        verbose_name="Liczba pytań",
                    ),
                ),
                (
                    "max_time",
                    models.IntegerField(
                        default=1,
                        help_text="Maksymalny czas trwania tesu [min]",
                        verbose_name="Czas na rozwiązanie",
                    ),
                ),
                (
                    "score_to_pass",
                    models.PositiveIntegerField(
                        help_text="Punkty wymagane do zaliczenia quizu [%]",
                        verbose_name="Punkty wymagane do zaliczenia",
                    ),
                ),
                (
                    "difficulty",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quiz",
                    models.ManyToManyField(related_name="questions", to="editor.quiz"),
                ),
            ],
        ),
        migrations.CreateModel(
